...
def update_vendor_performance(vendor_id:int):
    ...
    Return:
        Updating vendor details to HistoryPerformanceModel everytime updating 'completed' status in purchase order
    ...
    try:
        ...
        print('performance_history', ven_perf_data.items())
        if HistoryPerformanceModel.objects.filter(**default_val).exists():
            ven_perf_obj = HistoryPerformanceModel.objects.filter(**default_val).update(**ven_perf_data)
        else:
            ven_perf_obj = HistoryPerformanceModel.objects.create(**ven_perf_data)
...
class EditVendorAPI(APIView):
    ...
    def get(self, request, vendor_id):
        ...
        """
            Summary or Description of the Function:
                * Getting an Vendor data by Vendor_id.
        """
    ...
    def delete(self, request, vendor_id):
        ...
        """
            Summary or Description of the Function:
                * Deleting an Vendor data.

        """

        try:
            if self.get_queryset(vendor_id).delete():
                return Response({'message':'Vendor Successfully deleted'}, status=status.HTTP_200_OK)
            return Response({'error':'Something went wrong'}, status=status.HTTP_400_BAD_REQUEST)
...
class PurchaseOrderAPI(APIView):
    ...
    def get(self, request):
        ...
        """
            Summary or Description of the Function:
                * Getting an All Purchase Order data.
...
class EditPurchaseOrderAPI(APIView):
    ...
    def get(self, request, po_id):
        ...
        """
            Summary or Description of the Function:
                * Getting an Purchase Order data.
        """
    ...
    def delete(self, request, po_id):
        ...
        """
            Summary or Description of the Function:
                * Deleting an Purchase Order data.
        """
...
class VendorPerformanceAPI(APIView):
    ...
    def get(self, request, vendor_id):
        ...
        """
            Summary or Description of the Function:
                * Getting an Purchase Order Performance Of
                Every Vendor *.

        """

        try:
            queryset = HistoryPerformanceModel.objects.filter(vendor_id=vendor_id).first()
